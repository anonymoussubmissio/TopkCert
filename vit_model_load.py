...
model_vit=torch.load('./v_checkpoints/resnet50_k19.pt')
...
from utils.drs import gen_ablation_set
...
parser.add_argument("--model_dir", default='checkpointsss', type=str, help="directory of checkpoints")
...
parser.add_argument('--dataset', default='imagenet', type=str,
                    ...
                    help="dataset")
parser.add_argument("--model", default='vit_base_patch16_224_imagenet_drs_37', type=str, help="model name")
...
parser.add_argument("--ablation_size",type=int,default=17, help='override dumped file')
...
model_vit_model=model_vit['model']
